...
public class P1_JopApp {
    ...
    private final By continueButton = By.cssSelector("[data-testid=\"ArrowRightAltIcon\"]");
    private final By submitApplication = By.cssSelector("[type=\"submit\"]");
    ...
    public P1_JopApp clickOnContinue () throws InterruptedException {
        Thread.sleep(500);
    ...
    public P1_JopApp submitApplicationJop   (){
        driver.element().click(submitApplication);
        return this;
    }
